...
import { addLoginPopUp } from "../store/appSlice";
import { Bounce, ToastContainer, toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";

interface Review {
    // Define properties for reviews if needed
}
...
interface ProductDetailsProps {
    productData: ProductData; // Update type to ProductInfo
}
...
const ProductDetails: React.FC<ProductDetailsProps> = ({ productData }) => {
    ...
    const productForCart = {
        ...
        minimumOrderQuantity: Number(minimumOrderQuantity), // Convert to number
    ...
    const handleAddToCart = () => {
        if (!user) {
            ...
            // Showing login pop-up for 2 sec
